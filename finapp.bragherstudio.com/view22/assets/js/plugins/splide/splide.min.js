    ...
    var U = (function () {
        ...
        return (
          ...
          (u.go = function (t, n) {
            return (
              ...
              (this.State.is(3) || (this.State.is(4) && !n)) &&
          ...
          (u.destroy = function (t) {
            var n = this
            if ((void 0 === t && (t = true), !this.State.is(1))) {
              return (
                r(this.Components)
                  .reverse()
                  .forEach(function (n) {
                ...
                a = {
                  ...
                  isVisible: function () {
                    ...
                    var e = Math.ceil,
                      ...
                      r = M(i)
                    return t.options.direction === 'ttb'
      ...
      et = function (t, n) {
        var e,
          i,
          o,
          r = t.options.direction === 'ttb',
          s = t.is('fade'),
          a = t.options.direction === 'rtl',
          u = false,
          d = a ? 1 : -1,
          f = {
            sign: d,
            ...
            cancel: function () {
              t.is('loop') ? this.shift() : this.translate(this.position)
              E(o, { transition: '' })
            },
            shift: function () {
            ...
            trim: function (n) {
              return !t.options.trimSpace || t.is('loop')
                ? n
      ...
      it = function (t, n) {
        ...
        function a() {
          ...
          var e = n.autoWidth || n.autoHeight ? o.length : n.perPage,
            i = n.direction === 'ttb' ? 'Height' : 'Width',
    ...
    var rt = function (t, n) {
      ...
      at = function (t, n) {
          ...
          l = {
            ...
            mount: function () {
              ...
              t.on('touchstart mousedown', h, r)
                .on('touchmove mousemove', g, r, { passive: false })
        ...
        function g(n) {
          if (i) {
            if (((r = m(n, i)), s)) {
              if ((n.cancelable && n.preventDefault(), !t.is('fade'))) {
              ...
              })(r) && (t.emit('drag', i), (s = true), a.cancel(), p(n))
            }
          }
        }
        function v() {
          ...
          s &&
            ...
            (function (e) {
              ...
              if (o > 0) {
                ...
                t.is('slide') && (l = c(l, 0, u.edgeIndex))
      ...
      ut = function (t, n) {
        ...
        return {
          ...
          mount: function () {
            t.on('click', i, n.Elements.track, { capture: true })
              .on('drag', function () {
                e = true
              })
              .on('dragged', function () {
      ...
      lt = function (t, n, e) {
        ...
        function c() {
          var r = n.Controller,
            s = r.prevIndex,
            a = r.nextIndex,
            u = t.length > t.options.perPage || t.is('loop')
          o.disabled = a < 0 || !u
      ...
      gt = function (t, n, e) {
        ...
        function s(n, o) {
          var s = r.getItem(o),
            a = r.getItem(n)
          s && S(s.button, 'is-active')
          a && k(a.button, 'is-active')
      ...
      kt = function (t, n) {
        ...
        function r(n, e) {
          C(n, 'aria-hidden', !e)
          t.options.slideFocus && C(n, 'tabindex', e ? 0 : -1)
        }
        function s(t, n) {
          var e = i.track.id
          C(t, 'aria-controls', e)
        ...
        function u(n, i) {
          i && C(i.button, 'aria-current', true)
          n.items.forEach(function (n) {
            var i = t.options,
              o = d(
                false === i.focus && i.perPage > 1 ? e.pageX : e.slideX,
                n.page + 1
              ),
              r = n.button,
        ...
        function c(t, n, e) {
          n && I(n.button, 'aria-current')
          e && C(e.button, 'aria-current', true)
        }
        function f(t) {
          i.each(function (n) {
            var i = n.slide,
            ...
            C(i, 'aria-label', s)
            a && C(i, 'aria-controls', a.slide.id)
          })
        }
        function l(t, n) {
          var e = t.slide
          n ? C(e, 'aria-current', true) : I(e, 'aria-current')
        }
        function h(t) {
      ...
      zt = {
              ...
              mount: function () {
                ...
                r.slides.length > n.perPage &&
                  ...
                  (function () {
                    ...
                    n.pauseOnHover &&
                      (a(i, 'mouseleave', 1, true), a(i, 'mouseenter', 1, false))
                    n.pauseOnFocus &&
                      (a(i, 'focusout', 2, true), a(i, 'focusin', 2, false))
                    r.play &&
                      t.on(
                        'click',
                        function () {
                    ...
                    r.pause && a([r.pause], 'click', 3, false)
        ...
        LazyLoad: function (t, n, e) {
          ...
          function d(n, e) {
            ...
            w(n.parentElement, i)
            C(n, 'srcset', z(n, 'data-splide-lazy-srcset') || '')
            C(n, 'src', z(n, 'data-splide-lazy') || '')
          }
          function f() {
            if (i < r.length) {
              var t = r[i]
            ...
            mount: function () {
              t.on('mounted updated', function () {
                var e = t.options,
                  ...
                  o = _t[e.direction],
                  r = e.keyboard
                n && (t.off('keydown', n), I(i, 'tabindex'))
                r &&
                  ('focused' === r
                    ? ((n = i), C(i, 'tabindex', 0))
                    : (n = document),
